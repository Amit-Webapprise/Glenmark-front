      ...
      <div className="body-wrapper">
                        ...
                        <div className="row p-3">
                          <div className="col-lg-12">
                            <div className="mb-3">
                              ...
                              <select className="select2 js-example-basic-single select-label form-control w-100" name="select-label">
                                <option value="Senora" >Select Division</option>
                          ...
                          <div className="col-lg-12">
                            <div className="mb-3">
                              ...
                              <select className="select2 js-example-basic-single select-label form-control w-100" name="select-label">
                                <option value="Senora" >Select Designation</option>
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div className="mb-3">
                      ...
                      <select className="select2 js-example-basic-single select-label form-control w-100" id="Activity_name" name="select-label">
                        <option value="" >Select Activity Tag Name</option>
        ...
        <a href="tel:9925099250" className="glow-on-hover" type="button">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="29.968" height="29.968" viewBox="0 0 29.968 29.968">
            ...
            <g id="Mask_Group_50" data-name="Mask Group 50" transform="translate(6000 -2881)" clipPath="url(#clipPath)">
