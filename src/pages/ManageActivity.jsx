  ...
  return (
    <div className="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
      ...
      <div className="body-wrapper">
        <Header />
        <html><head></head><body><div className="container-fluid">

  <div className="rs_white_shadow">
    
    <div className="row g-2 mb-3 justify-content-end">

      <div className="col-lg-auto col-md-auto col-sm-auto col-auto my-auto my-auto me-auto">
        <h2 className="main_title">Manage Poster <a href="" className="text-dark ms-1" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Lorem Ipsum is simply dummy text of the printing and typesetting industry."><i className="fa-solid fa-circle-info"></i></a></h2>
      </div>
      ...
      <div className="col-lg-auto col-md-auto col-sm-auto col-auto my-auto">
        <a href="" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_activity"> <i className="fa fa-plus me-2"></i> Add New Activity </a>
      </div>
      <div className="col-lg-auto  col-md-auto col-sm-auto col-auto my-auto">
        <div className="filter_click">
          <a className="btn btn-outline-primary open_filter" href="" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Filter">
              ...
              <div className="flter_br">
                <div className="row">
                  ...
                  <div className="col-auto">
                    <a href="" className="close_fliter">2 <i className="fa-solid fa-xmark ms-1"></i></a>
                  </div>
                </div>
              </div>
              <div className="row p-3">
                <div className="col-lg-12">
                  <div className="mb-3">
                    ...
                    <select className="select2 js-example-basic-single select-label form-control w-100" name="select-label">
                      <option value="Senora" selected="">Select Division</option>
                ...
                <div className="col-lg-12">
                  <div className="mb-3">
                    ...
                    <select className="select2 js-example-basic-single select-label form-control w-100" name="select-label">
                      <option value="Senora" selected="">Select Designation</option>
                      <option value="Senora">Designation 1</option>
                      <option value="Senora">Designation 2</option>
                      <option value="Senora">Designation 3</option>
                    </select>
                  </div>
                </div>
                <div className="col-lg-12">
                  <div className="mb-3">
                    ...
                    <select className="select2 js-example-basic-single select-label form-control w-100" name="select-label">
                      ...
                      <option value="Senora">Active</option>
                      <option value="Senora">Inactive</option>
                    </select>
                  </div>
                </div>
                <div className="col-lg-12 text-end">
                  <a href="#" className="btn btn-outline-primary"> Reset </a>
    ...
    <div className="row">
      <div className="col-12">
        <div className="white_table">
          <div className="br_outside">
            <div className="row">
              
              <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                
                <div className="list_gallery_img">
                  <div className="all_img_gallery">
                    <div className="item" data-type="Doctor">
                      <div className="full_box">
                       
                        <div className="day_img">
                          <Link to="/doctor-e-card">
                            
                            <img src="../assets/images/ho/liver_day.png" />
                            <span className="number">01</span>
                            <span className="priority">Priority</span>
                          </Link>
                        </div>
                        <div className="in_day">
                          <div className="rs_top_set_gallery">
                            <div className="rs_left">
                              <h4>Liver Cancer Day</h4>
                            </div>
                            <div className="rs_right">
                              <div className="rank_gallery img_pad">
                                <a href=""><img src="../assets/images/ho/small_gallery.png" /> 16</a>
                                <a href=""><img src="../assets/images/ho/small_video.png" /> 05</a>
                              </div>
                            </div>
                          </div>
                          <div className="gallery_img_rs">
                            <div className="left">                              
                              
                              <div className="rank_gallery">
                                <Link className="btn btn-primary me-2" to="/add-new-activity">
                                  <img src="../assets/images/ho/add_white.png" />
                                </Link>
                                
                                <button className="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#edit_activity">
                                  <img src="../assets/images/ho/edit_white.png" />
                                </button>
                                
                                <button className="btn btn-primary me-0 move_items">
                                  <img src="../assets/images/ho/drag.png" />
                                </button>
                    ...
                    <div className="item" data-type="Chemist">
                      <div className="full_box">
                       
                        <div className="day_img">
                          <Link to="/doctor-e-card">
                            <img src="../assets/images/ho/heart_day.jpg" />
                    ...
                    <div className="item" data-type="Doctor">
                      <div className="full_box">
                        ...
                        <div className="day_img">
                          <Link to="/doctor-e-card">
                            <img src="../assets/images/ho/birthday_day.png" />
                    ...
                    <div className="item" data-type="Stockist">
                      <div className="full_box">
                       
                        <div className="day_img">
                          <Link to="/doctor-e-card">
                            <img src="../assets/images/ho/cme_day.png" />
                      ...
                      <div className="full_box">
                        ...
                        <div className="day_img">
                          <Link to="/doctor-e-card">
                            ...
                            <img src="../assets/images/ho/du_img.png" />
                            <span className="number">01</span>
                            <span className="priority">Priority</span>
                          </Link>
                        </div>
...
<div className="modal fade" id="more_division" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered">
      <div className="modal-content">
        <div className="modal-header">
          <h1 className="modal-title fs-5" id="exampleModalLabel">Division</h1>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div className="modal-body">
          <div className="mb-3">
            <span className="grey_label">Division 1</span>
            <span className="grey_label">Division 2</span>
            <span className="grey_label">Division 3</span>
            <span className="grey_label">Division 4</span>
            <span className="grey_label">Division 5</span>
            <span className="grey_label">Division 6</span>
            <span className="grey_label">Division 7</span>
...
<div className="modal fade" id="add_activity" tabindex="-1" aria-labelledby="" aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-lg">
      <div className="modal-content">
        <div className="modal-header">
          <h1 className="modal-title fs-5" id="">Add New Activity</h1>
        ...
        <div className="modal-body">
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-12">
              <div className="mb-3">
                <label htmlFor="" className="form-label">Activity Name <span className="text-danger">*</span></label>
                <input type="" className="form-control" id="" placeholder="Enter Activity Name" />
              </div>
            </div>
            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-12">
              <div className="mb-3">
                <label htmlFor="" className="form-label">Activity Tag Name <span className="text-danger">*</span></label>
                <select className="select2 js-example-basic-single select-label form-control w-100" id="Activity_name" name="select-label">
                  <option value="" selected="">Select Activity Tag Name</option>
                  <option value="Yes">Yes</option>
                  <option value="No">No</option>
                </select>
              </div>
            </div>
            <div className="col-lg-12 col-md-12 col-sm-12 col-12 tag_name_show">
              <div className="mb-3">
                <label htmlFor="" className="form-label">Activity Tag Name <span className="text-danger">*</span></label>
                <input type="" className="form-control" id="" placeholder="Enter Activity Tag Name" />
              </div>
            </div>
            <div className="col-lg-12 col-md-12 col-sm-12 col-12">
              <div className="mb-0">
                <label htmlFor="" className="form-label">Upload Activity Cover Image <span className="text-danger">*</span></label>
                <div className="rs_upload_img cover_gallery">
                  <input type="file" />
                  <img src="../assets/images/ho/cover_gallery.png" />
                  <h5>Upload Image</h5>
                  <p>(Preferred size 250 × 250)</p>
                </div>
              </div>
            </div>
          </div>
...
<div id="chat-widget" className="chat-widget">
    ...
    <div id="chat-window" className="hidden">
        <div id="chat-header">
            ...
            <button type="button" id="close-chat" aria-label="Close chat">×</button>
        </div>
...
<div className="modal fade" id="systemUpgradeModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div className="modal-dialog modal-dialog-centered modal-lg">
