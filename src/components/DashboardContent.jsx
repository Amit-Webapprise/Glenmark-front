  ...
  <div className="rs_white_shadow">
    ...
    <div className="row">
      <div className="col-auto">
        <h2 className="main_title">Dashboard <Link to="" className="text-dark ms-1" data-bs-toggle="tooltip"
            data-bs-placement="right"
            data-bs-title="View a quick snapshot of all digital activities and performance across modules."><i
              className="fa-solid fa-circle-info"></i></Link></h2>
      ...
      <div className="col-lg-auto col-sm-auto col-12">
        <div className="col-lg-auto">
          <div className="d-flex align-items-center">
            ...
            <Link to="#" className="btn btn-primary ms-2"><i className="fa fa-search"></i></Link>
            <Link to="#" className="btn btn-danger ms-2"><i className="fa fa-times"></i></Link>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="row g-3 mt-0">
          ...
          <div className="col col_new">
            <div className="new_chear_view new_rs_box_desing shimmer-wrapper" style={{"background":"rgb(141 93 244 / 27%)"}}>
              ...
              <h4>45</h4>
              <p>Total FB video</p>
              <Link to="/video" target="_blank" className="rs-link_bottom_fixed"><i className="fa-solid fa-link"></i></Link>
            </div>
          </div>
          <div className="col col_new">
            <div className="new_chear_view new_rs_box_desing shimmer-wrapper" style={{"background":"rgb(246 163 74 / 27%)"}}>
              ...
              <Link to="/webinar-management" target="_blank" className="rs-link_bottom_fixed"><i className="fa-solid fa-link"></i></Link>
            </div>
          </div>
          <div className="col col_new">
            <div className="new_chear_view new_rs_box_desing shimmer-wrapper" style={{"background":"rgb(252 89 86 / 27%)"}}>
              ...
              <Link to="/in-all-activity" target="_blank" className="rs-link_bottom_fixed"><i className="fa-solid fa-link"></i></Link>
            </div>
          </div>
          <div className="col col_new">
            <div className="new_chear_view new_rs_box_desing shimmer-wrapper" style={{"background":"rgb(13 204 35 / 27%)"}}>
              ...
              <Link to="/whatsapp-campaign-manage" target="_blank" className="rs-link_bottom_fixed"><i className="fa-solid fa-link"></i></Link>
            </div>
          </div>
          <div className="col col_new">
            <div className="new_chear_view new_rs_box_desing shimmer-wrapper" style={{"background":"rgb(115 168 228 / 27%)"}}>
              ...
              <Link to="/mail-campaign-manage" target="_blank" className="rs-link_bottom_fixed"><i className="fa-solid fa-link"></i></Link>
            </div>
          </div>
        </div>
